...
## [2026-08-12] - 选题与口播轻量加强

- **laohan-redian** v2.4.0 — 选题候选新增 Jeffrey `creator_fit`、独特判断与第七维评分，缺个人成立理由的候选不得入选。
- **laohan-chuangzuo** v1.9.0 — 默认签名开场允许有理由的题目专属例外；原创增量不再硬凑两项，并新增绑定内容单位的轻量可视化锚点。
- **laohan-bianpai** v1.19.0 — 对上述选题与口播合同增加机械校验，不新增业务阶段。
