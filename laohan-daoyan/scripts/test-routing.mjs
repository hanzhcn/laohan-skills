...
if (method.method_version !== 'V5' || method.mode !== 'DIRECTOR_FIRST' || method.visual_quality_floor?.mode !== 'LIGHTWEIGHT_RESULT_ONLY' || !template.includes('quality_floor_policy: LIGHTWEIGHT_RESULT_ONLY')) throw new Error('Skill引用的项目V5方法或视觉底线不匹配');
