---
name: content-organize-v3-6
description: Layer A/B 结构化整理法 v3.6，进宝核心能力
---

# Skill — 内容整理规则 v3.6（生产交付版）
...
| DF 内容适配 | 15% | /10 | 内容单位是否完整且各有独立支撑？单位少时是否明确保持自然短稿？ |
...
建议: （给富贵的写作提示，如"重点补资源钩子""需删去同义模块并保持自然稿长"等）
```
